		 ...
		 <button type="button" class="btn btn-primary mb-2" data-toggle="modal" data-target="#myModal">
                ...
                <div class="table-responsive-xl" >
                    ...
                    ?>
                     ...
                     <!-- registro cliente -->
                     <form class="modal fade" id="myModal" method="POST" action="vendedor_sql_registro.php">
				...
				<h5 class="modal-title" id="myModalLabel">REGISTRAR VENDEDOR</h5>
                            </div>
                            <!-- Modal body -->
                                ...
                                <table class="table table-hover">
                                    ...
                                    <div class="form-vertical"  autocomplete="off">
                                        <div class="form-group"> 
                                             <div class="col-sm-10">
                                            <label for="id" class="col-sm-2 control-label">ID_VENDEDOR</label>
                                            <input  id="id_vendedor" name="id_vendedor" type="text"  class="form-control" placeholder="Id vendedor" required >  
                                         </div>
                                            </div>
                                        <div class="form-group">                                            
                ...
                <!-- The Modal editar -->
                <form class="modal fade" id="editUsu" method="POST" action="vendedor_sql_actualizar.php">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <!-- Modal Header -->
                            <div class="modal-header">
				...
				<h5 class="modal-title" id="myModalLabel">ACTUALIZAR VENDEDOR</h5>
                            </div>
                            <!-- Modal body -->
                            <div class="modal-body">
                ...
                <!-- Modal eliminar -->
               <form class="modal fade" id="confirm-delete" method="POST" action="vendedor_sql_eliminar.php">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <!-- Modal Header -->
                            <div class="modal-header">
				...
				<h5 class="modal-title" id="myModalLabel">ELIMINAR VENDEDOR</h5>
                            </div>
                            <!-- Modal body -->
                            <div class="modal-body">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <div class="form-vertical"  autocomplete="off">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                 <label for="telefono" class="col-sm-2 control-label">telefono:</label>
                                                <input type="text" class="form-control" id="telefonos" name="telefonos" placeholder="telefonos" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group">
            ...
            <script>
                ...
                $('#confirm-delete').on('show.bs.modal',function  (event)  {
                    ...
                    var recipient5 = button.data('telefonos');
                    ...
                    modal.find('.modal-body #telefonos').val(recipient5);
